...
def compute_information_gain(X, y, node_indices, feature):
    ...
    # Calculate the entropy of the left and right branches
    H_left = compute_entropy(y_left)
    H_right = compute_entropy(y_right)
    
    # Calculate the weights for left and right branches
...
def get_best_split(X, y, node_indices):   
    ...
    ### START CODE HERE ###
    max_info_gain = 0  # Initialize with a very small value
    
    # Loop through each feature and compute the information gain
    for feature in range(num_features):
        # Calculate information gain for this feature
        info_gain = compute_information_gain(X, y, node_indices, feature)
        
        # If this information gain is the highest we've seen, update best_feature
